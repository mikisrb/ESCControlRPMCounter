...
#define LCD_H
/*************************************************************************
 Title	:   C include file for the HD44780U BrojacFrekvence1 library (lcd.c)
...
/**
 ...
 @file
 @defgroup pfleury_lcd BrojacFrekvence1 library <lcd.h>
 @code #include <lcd.h> @endcode
 
 @brief Basic routines for interfacing a HD44780U-based character BrojacFrekvence1 display

 BrojacFrekvence1 character displays can be found in many devices, like espresso machines, laser printers. 
 ...
 @see The chapter <a href=" http://homepage.hispeed.ch/peterfleury/avr-lcd44780.html" target="_blank">Interfacing a HD44780 Based BrojacFrekvence1 to an AVR</a>
      on my home page, which shows example circuits how to connect an BrojacFrekvence1 to an AVR controller. 
...
/*
 * BrojacFrekvence1 and target specific definitions below can be defined in a separate include file with name lcd_definitions.h instead modifying this file 
...
/**
 * @name  Definition for BrojacFrekvence1 controller type
 ...
 *
 * The four BrojacFrekvence1 data lines and the three control lines RS, RW, E can be on the 
...
#ifndef LCD_PORT
#define LCD_PORT         PORTD        /**< port for the BrojacFrekvence1 lines   */
#endif
#ifndef LCD_PORT_COMMAND
#define LCD_PORT_COMMAND         PORTB       /**< port for the BrojacFrekvence1 COMMAND lines   */
#endif
...
/**
 * @name Definitions for BrojacFrekvence1 command instructions
 * The constants define the various BrojacFrekvence1 controller instructions which can be passed to the 
...
#define LCD_BUSY              7      /* DB7: BrojacFrekvence1 is busy                    */
...
/**
 @brief    Send BrojacFrekvence1 controller instruction command
 @param    cmd instruction to send to BrojacFrekvence1 controller, see HD44780 data sheet
 @return   none
*/
...
/**
 @brief    Send data byte to BrojacFrekvence1 controller 
 
 Similar to lcd_putc(), but without interpreting LF
 @param    data byte to send to BrojacFrekvence1 controller, see HD44780 data sheet
 @return   none
*/
